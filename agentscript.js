...
(function() {
  var XY, pt, u, _base, _i, _len, _ref,
  ...
  ABM.shapes = (function() {
    ...
    return {
      ...
      drawSprite: function(ctx, s, x, y, size, rot) {
        if (rot === 0) {
  ...
  ABM.Patches = (function(_super) {
    ...
    Patches.prototype.setDefaultVariable = function(name, value) {
      return ABM.Patch.prototype[name] = value;
    };
  ...
  ABM.Agent = (function() {
    ...
    Agent.prototype.draw = function(ctx) {
      ...
      rot = shape.rotate ? this.heading : 0;
      if (this.sprite != null) {
        return ABM.shapes.drawSprite(ctx, this.sprite, this.x, this.y, this.size, rot);
      } else {
        return ABM.shapes.draw(ctx, shape, this.x, this.y, this.size, rot, this.color);
      }
    };
  ...
  ABM.Agents = (function(_super) {
    ...
    Agents.prototype.own = function() {
      var i, name, others, value, _j, _len1, _results;
      ...
      _results = [];
      for (i = _j = 0, _len1 = others.length; _j < _len1; i = _j += 2) {
        name = others[i];
  ...
  ABM.Links = (function(_super) {
    ...
    Links.prototype.setDefaultVariable = function(name, value) {
      return this.breedClass.prototype[name] = value;
    };
