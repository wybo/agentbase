...
(function() {
  ...
  ABM.util = u = {
    ...
    resizeCtx: function(ctx, width, height, scale) {
      ...
      this.ctxToImage(ctx, function(img) {
        if (scale) {
  ...
  ABM.shapes = ABM.util.s = (function() {
    ...
    return {
      ...
      shapeToSprite: function(name, color, size) {
        ...
        if (size * ctx.nextX === ctx.canvas.width) {
        ...
        if ((img = shape.img) != null) {
          if ((imgslot = ctx.images[name]) != null) {
            return imgslot;
          }
  ...
  ABM.Patches = (function(_super) {
    ...
    function Patches(size, minX, maxX, minY, maxY, isTorus, neighbors) {
      ...
      for (y = _i = minY; _i <= maxY; y = _i += 1) {
        for (x = _j = minX; _j <= maxX; x = _j += 1) {
    ...
    Patches.prototype.setDefaultVariable = function(name, value) {
      if (typeof name !== "string") {
        u.error("setDefaultVariable: name is not a string");
      }
      ABM.Patch.prototype[name] = value;
      return ABM.Patch.prototype.ownVariables.push(name);
    };

    Patches.prototype.own = function() {
      var i, name, others, value, _i, _len, _results;
      name = arguments[0], value = arguments[1], others = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
      this.setDefaultVariable(name, value);
      if (others.length % 2 !== 0) {
        u.error("own: odd number of arguments");
      }
      _results = [];
      for (i = _i = 0, _len = others.length; _i < _len; i = _i += 2) {
        name = others[i];
        _results.push(this.setDefaultVariable(name, others[i + 1]));
      }
      return _results;
    };
  ...
  ABM.Agents = (function(_super) {
    ...
    function Agents(breedClass, name, mainSet) {
      ...
      this.breedClass.prototype.breed = this;
    ...
    Agents.prototype.setDefaultColor = function(color) {
      return this.breedClass.prototype.color = color;
    };

    Agents.prototype.setDefaultShape = function(shape) {
      return this.breedClass.prototype.shape = shape;
    };

    Agents.prototype.setDefaultSize = function(size) {
      return this.breedClass.prototype.size = size;
    };

    Agents.prototype.setDefaultHeading = function(heading) {
      return this.breedClass.prototype.heading = heading;
    };

    Agents.prototype.setDefaultHidden = function(hidden) {
      return this.breedClass.prototype.hidden = hidden;
    };

    Agents.prototype.setDefaultSprite = function() {
      if (this.breedClass.prototype.color != null) {
        return this.breedClass.prototype.sprite = ABM.shapes.shapeToSprite(this.breedClass.prototype.shape, this.breedClass.prototype.color, this.breedClass.prototype.size * ABM.patches.size);
      }
    };
    ...
    Agents.prototype.setDefaultPen = function(size, down) {
      ...
      this.breedClass.prototype.penSize = size;
      return this.breedClass.prototype.penDown = down;
    };

    Agents.prototype.setDefaultVariable = function(name, value) {
      if (typeof name !== "string") {
        u.error("setDefaultVariable: name is not a string");
      }
      this.breedClass.prototype[name] = value;
      return this.breedClass.prototype.ownVariables.push(name);
    };
    ...
    Agents.prototype.add = function(agent) {
      if (this.mainSet != null) {
        this.mainSet.add(agent);
        this.push(agent);
      } else {
        Agents.__super__.add.call(this, agent);
      }
      return agent;
    };

    Agents.prototype.remove = function(agent) {
      Agents.__super__.remove.call(this, agent);
      if (this.mainSet != null) {
        return this.mainSet.remove(agent);
      }
    };
  ...
  ABM.Links = (function(_super) {
    ...
    function Links(breedClass, name, mainSet) {
      this.breedClass = breedClass;
      this.name = name;
      this.mainSet = mainSet != null ? mainSet : null;
    ...
    Links.prototype.setDefaultThickness = function(thickness) {
      return this.breedClass.prototype.thickness = thickness;
    };
    ...
    Links.prototype.setDefaultVariable = function(name, value) {
      if (typeof name !== "string") {
        u.error("setDefaultVariable: name is not a string");
      }
      this.breedClass.prototype[name] = value;
    ...
    Links.prototype.add = function(agent) {
      if (this.mainSet != null) {
        this.mainSet.add(agent);
        this.push(agent);
      } else {
        Links.__super__.add.call(this, agent);
      }
      return agent;
    };

    Links.prototype.remove = function(agent) {
      Links.__super__.remove.call(this, agent);
      if (this.mainSet != null) {
        return this.mainSet.remove(agent);
      }
    };
    ...
    Links.prototype.create = function(from, to, init) {
      ...
      for (_i = 0, _len = to.length; _i < _len; _i++) {
        ...
        _results.push((function(o) {
          init(o);
          return o;
        })(this.add(new this.breedClass(from, a))));
      }
      return _results;
    };
  ...
  ABM.Model = (function() {
    ...
    function Model(div, size, minX, maxX, minY, maxY, torus, neighbors) {
      var a, ctx, k, v, _i, _len, _ref, _ref1;
      if (torus == null) {
        torus = true;
      }
      if (neighbors == null) {
        ...
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          ...
          if (!a.hasOwnProperty("sprite")) {
            if (a.hasOwnProperty("color" || a.hasOwnProperty("shape" || a.hasOwnProperty("size")))) {
              a.sprite = ABM.shapes.shapeToSprite(a.shape, a.color, a.size * this.patches.size);
            }
          }
        }
      }
    ...
    Model.prototype.createBreeds = function(s, breedClass, breedSet) {
      var Breed, b, breeds, c, _i, _len, _ref;
      breeds = [];
      breeds.classes = {};
      breeds.sets = {};
      _ref = s.split(" ");
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        c = Breed = (function(_super) {
          ...
          function Breed() {
            Breed.__super__.constructor.apply(this, arguments);
          }
