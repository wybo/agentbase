...
(function() {
  ...
  describe("Array", function() {
    describe("from", function() {
      return it("Turns array into an ABM.Array", function() {
        var array;
        array = ABM.Array.from([3, 2, 1]);
        expect(array.length).toBe(3);
        expect(typeof array.histogram).toBe('function');
        return expect(array.constructor.name).toBe('Array');
      });
    });
    describe("constructor", function() {
      return it("Creates the array", function() {
        var array;
        array = new ABM.Array;
    ...
    describe("sample", function() {
      ...
      it("returns the number object if number given", function() {
        var array;
        u.randomSeed(2);
    ...
    describe("sort", function() {
      return it("sorts the array", function() {
        ...
        u.sort(array, function(objectA, objectB) {
  ...
  describe("Set", function() {
    describe("constructor", function() {
      ...
      return it("Creates a subset", function() {
        var model, set;
        model = t.setupModel();
        set = new ABM.BreedSet(ABM.Agent, "ducks", ABM.Agent.prototype.breed);
        expect(set.length).toBe(0);
    ...
    describe("remove", function() {
      return it("Removes from both sets", function() {
        ...
        return expect(u.contains(model.citizens, agent)).not.toBe(true);
      });
    });
    describe("pop", function() {
      return it("Removes last object", function() {
        ...
        return expect(u.contains(model.agents, agent)).not.toBe(true);
      });
    });
  ...
  describe("Set", function() {
    ...
    describe("setDefault", function() {
      it("Sets the default", function() {
        ...
        return expect(ABM.Agent.prototype.size).toBe(17);
      });
      return it("The default gets propagated", function() {
        ...
        model = t.setupModel();
        expect(ABM.Agent.prototype.shape).toBe("square");
  ...
  describe("Util", function() {
    ...
    describe("ownKeys", function() {
      return it("returns the attributes", function() {
        ...
        return expect(u.ownKeys(object)).toEqual(["bull", "fly"]);
      });
    });
    describe("ownVariableKeys", function() {
      return it("returns the attributes that are not functions", function() {
        ...
        return expect(u.ownVariableKeys(object)).toEqual(["bull"]);
      });
    });
    describe("ownValues", function() {
      return it("returns the values", function() {
        ...
        return expect(u.ownValues(object)).toEqual(["pen", object.fly]);
      });
    });
    describe("toFixed", function() {
      return it("returns the array rounded, as strings", function() {
        return expect(u.toFixed([1.334, 5.445, 11.666], 1)).toEqual(["1.3", "5.4", "11.7"]);
      });
    });
