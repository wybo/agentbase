...
(function() {
  ...
  ABM.Animator = (function() {
    function Animator(model, rate, multiStep, isHeadless) {
      this.model = model;
      this.rate = rate != null ? rate : 30;
      this.multiStep = multiStep != null ? multiStep : false;
      this.isHeadless = isHeadless != null ? isHeadless : false;
    ...
    Animator.prototype.setRate = function(rate, multiStep) {
      var _ref;
      this.rate = rate;
      this.multiStep = multiStep != null ? multiStep : (_ref = this.multiStep) != null ? _ref : false;
  ...
  ABM.Model = (function() {
    ...
    function Model(div, size, minX, maxX, minY, maxY, isTorus, hasNeighbors, isHeadless) {
      var ctx, k, v, _ref;
      if (size == null) {
        size = 13;
      }
      ...
      ABM.model = this;
      this.setWorld(size, minX, maxX, minY, maxY, isTorus, hasNeighbors, isHeadless);
      ...
      if (isHeadless) {
        this.anim = new ABM.Animator(this, null, true, isHeadless);
      } else {
