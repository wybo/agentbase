...
(function() {
  ...
  ABM.util.array = {
    ...
    getProp: function(array, property) {
    ...
    getPropWith: function(array, property, value) {
      var object;
      return this.from((function() {
        var _i, _len, _results;
        _results = [];
    ...
    setProp: function(array, property, value) {
  ...
  ABM.util.array.extender = {
    ...
    extend: function(util) {
      ...
      for (_i = 0, _len = methods.length; _i < _len; _i++) {
        method = methods[_i];
        _results.push(util[method] = ABM.util.array[method]);
      }
      return _results;
    }
  };
  ...
  ABM.Link = (function() {
    ...
    Link.prototype.die = function() {
      this.breed.remove(this);
      u.remove(this.from.links, this);
      u.remove(this.to.links, this);
      return null;
    };
