...
(function() {
  ...
  ABM.Model = (function() {
    ...
    function Model(divOrOpts, size, minX, maxX, minY, maxY, isTorus, hasNeighbors, isHeadless) {
      ...
      Patches = this.extend(ABM.Patches);
      Patch = this.extend(ABM.Patch);
      Agents = this.extend(ABM.Agents);
      Agent = this.extend(ABM.Agent);
      Links = this.extend(ABM.Links);
      Link = this.extend(ABM.Link);
      this.patches = ABM.patches = new Patches(Patch, "patches");
      this.agents = ABM.agents = new Agents(Agent, "agents");
      this.links = ABM.links = new Links(Link, "links");
