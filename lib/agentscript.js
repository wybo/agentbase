...
(function() {
  ...
  ABM.Model = (function() {
    ...
    function Model(options) {
      ...
      this.Patches = this.extendWithModel(this.world.Patches);
      this.Patch = this.extendWithModel(this.world.Patch);
      this.Agents = this.extendWithModel(this.world.Agents);
      this.Agent = this.extendWithModel(this.world.Agent);
      this.Links = this.extendWithModel(this.world.Links);
      this.Link = this.extendWithModel(this.world.Link);
      this.Set = this.extendWithModel(this.world.Set);
