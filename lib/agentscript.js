...
(function() {
  ...
  ABM.shapes = ABM.util.s = (function() {
    ...
    return {
      ...
      shapeToSprite: function(name, color, size, model) {
  ...
  ABM.Agent = (function() {
    ...
    Agent.prototype.setSprite = function(sprite) {
      ...
      if ((s = sprite) != null) {
        ...
        return this.sprite = ABM.shapes.shapeToSprite(this.shape, this.color, this.size, this.model);
      }
    };
  ...
  ABM.Model = (function() {
    ...
    function Model(divOrOpts, size, minX, maxX, minY, maxY, isTorus, hasNeighbors, isHeadless) {
      var Agent, Agents, Link, Links, Patch, Patches, ctx, div, k, v, _ref;
      if (size == null) {
        size = 13;
      }
      if (minX == null) {
      ...
      Patches = this.Patches = this.extend(ABM.Patches);
      Patch = this.extend(ABM.Patch);
      Agents = this.Agents = this.extend(ABM.Agents);
      Agent = this.extend(ABM.Agent);
      Links = this.Links = this.extend(ABM.Links);
      Link = this.extend(ABM.Link);
      this.patches = new Patches(Patch, "patches");
      this.agents = new Agents(Agent, "agents");
      this.links = new Links(Link, "links");
