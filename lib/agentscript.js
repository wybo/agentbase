...
(function() {
  ...
  ABM.util = u = {
    ...
    lerp: function(from, to, scale) {
      return from + (to - from) * u.clamp(scale, 0, 1);
    },
    normalize: function(array, from, to) {
      ...
      for (_i = 0, _len = array.length; _i < _len; _i++) {
        num = array[_i];
        _results.push(this.lerp(from, to, scale * (num - min)));
      }
      return _results;
    },
  ...
  ABM.AgentSet = (function(_super) {
    ...
    AgentSet.prototype.own = function() {
      var name, val, vars, _i, _len, _ref;
      vars = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      for (_i = 0, _len = vars.length; _i < _len; _i++) {
        name = vars[_i];
        val = null;
        if (u.isArray(name)) {
          _ref = name, name = _ref[0], val = _ref[1];
        }
        this.setDefault(name, val);
    ...
    AgentSet.prototype.setProps = function(prop, values) {
      var i, o, _i, _len;
      for (i = _i = 0, _len = this.length; _i < _len; i = ++_i) {
        o = this[i];
        o[prop] = values[i];
  ...
  ABM.Patch = (function() {
    ...
    Patch.prototype.draw = function(ctx) {
      ...
      if (this.label != null) {
        ...
        ctx.scale(1 / this.breed.size, -1 / this.breed.size);
  ...
  ABM.Patches = (function(_super) {
    ...
    Patches.prototype.draw = function(ctx) {
      if ((this.agentClass.prototype.color != null) && !this[0].hasOwnProperty("color")) {
        u.fillCtx(ctx, this.agentClass.prototype.color);
        return console.log("draw: fill used.");
    ...
    Patches.prototype.pixelXYtoPatchXY = function(x, y) {
      var px, py;
      px = this.minXcor + (x / this.size);
      py = this.maxYcor - (y / this.size);
      return [px, py];
    };
  ...
  ABM.Model = (function() {
    ...
    function Model(div, size, minX, maxX, minY, maxY, isTorus, hasNeighbors) {
      ...
      u.waitOnFiles((function() {
        return _this.modelReady = true;
      }));
    }

    Model.prototype.setupAndGo = function() {
      var _this = this;
      return u.waitOn((function() {
