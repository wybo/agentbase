...
(function() {
  ...
  ABM.Agent = (function() {
    ...
    Agent.prototype.angleTowards = function(point) {
      return u.radiansToward(this.position, point, ABM.patches);
    };
    ...
    Agent.prototype.closestTorusPoint = function(point) {
      return u.closestTorusPoint(this.position, point, ABM.patches.numX, ABM.patches.numY);
    };
    ...
    Agent.prototype.draw = function(context) {
      ...
      if ((this.sprite != null) || this.breed.useSprites) {
        ...
        ABM.shapes.drawSprite(context, this.sprite, this.position.x, this.position.y, this.size, radians);
      } else {
        ABM.shapes.draw(context, shape, this.position.x, this.position.y, this.size, radians, this.color);
      }
      if (this.label != null) {
  ...
  ABM.Link = (function() {
    ...
    Link.prototype.draw = function(context) {
      ...
      if (!ABM.patches.isTorus) {
        context.moveTo(this.end1.position.x, this.end1.position.y);
        context.lineTo(this.end2.position.x, this.end2.position.y);
      } else {
        point = this.end1.closestTorusPoint(this.end2.position);
        context.moveTo(this.end1.position.x, this.end1.position.y);
        context.lineTo(point.x, point.y);
        if (point.x !== this.end2.position.x || point.y !== this.end2.position.y) {
          point = this.end2.closestTorusPoint(this.end1.position);
          context.moveTo(this.end2.position.x, this.end2.position.y);
          context.lineTo(point.x, point.y);
        }
      }
      context.closePath();
      ...
      context.restore();
      if (this.label != null) {
        x0 = u.linearInterpolate(this.end1.position.x, this.end2.position.x, .5);
        y0 = u.linearInterpolate(this.end1.position.y, this.end2.position.y, .5);
    ...
    Link.prototype.length = function() {
      return this.end1.distance(this.end2.position);
    };
  ...
  ABM.Model = (function() {
    ...
    function Model(options) {
      var context, div, isHeadless, k, v, _ref;
      ABM.model = this;
      div = options.div;
