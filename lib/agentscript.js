...
(function() {
  ...
  ABM.Model = (function() {
    ...
    Model.prototype.setWorld = function(options) {
      var defaults, hasNeighbors, isHeadless, isTorus, k, maxX, maxXcor, maxY, maxYcor, minX, minXcor, minY, minYcor, numX, numY, pxHeight, pxWidth, size, v;
      defaults = {
        size: 13,
        minX: -16,
        maxX: 16,
  ...
  ABM.Patches = (function(_super) {
    ...
    Patches.prototype.cacheRect = function(radius, meToo) {
      ...
      for (_i = 0, _len = this.length; _i < _len; _i++) {
        p = this[_i];
        p.pRect = this.patchRectangle(p, radius, radius, meToo);
    ...
    Patches.prototype.patchRectangle = function(p, dx, dy, meToo) {
