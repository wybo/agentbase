...
(function() {
  ...
  ABM.util = u = {
    ...
    sample: function(array, number) {
      var newArray, newLength, object;
      if (number != null) {
        newLength = Math.min(array.length, Math.floor(number));
        newArray = [];
        while (newArray.length < newLength) {
          object = this.sample(array);
          if (__indexOf.call(newArray, object) < 0) {
  ...
  ABM.AgentSet = (function(_super) {
    ...
    AgentSet.prototype.sample = function(number) {
      var random;
      random = u.sample(this, number);
      if (random.isArray) {
