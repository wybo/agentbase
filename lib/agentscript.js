...
(function() {
  ...
  ABM.util = u = {
    ...
    lightenColor: function(color, fraction) {
      var i, newColor, value, _i, _len;
      newColor = [];
      for (i = _i = 0, _len = color.length; _i < _len; i = ++_i) {
        value = color[i];
        newColor[i] = this.clamp(Math.round(value + fraction * 255), 0, 255);
      }
      return newColor;
    },
    ...
    randomMapColor: function(c, set) {
      ...
      return this.setColor(c, this.sample(set), this.sample(set), this.sample(set));
    },
    ...
    parseQueryString: function(query) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (t.length === 1) {
          ...
          res[t[0]] = this.parseToPrimitive(t[1]);
        }
      }
      return res;
    },
    ...
    sample: function(array, numberFunction, conditionFunction) {
      ...
      if (this.isFunction(numberFunction)) {
      ...
      if (number != null) {
        ...
        while (newArray.length < number && (object != null)) {
          object = this.sample(array, conditionFunction);
  ...
  ABM.BreedSet = (function(_super) {
    ...
    BreedSet.prototype.remove = function(object) {
      if (this.mainSet != null) {
        u.removeItem(this.mainSet, object);
      }
      u.removeItem(this, object);
      return this;
    };
  ...
  ABM.Agent = (function() {
    ...
    Agent.prototype.scaleColor = function(color, s) {
      if (!this.hasOwnProperty("color")) {
        this.color = u.clone(this.color);
      }
      return u.scaleColor(color, s, this.color);
    };
    ...
    Agent.prototype.setXY = function(x, y) {
      ...
      oldPatch = this.patch;
      this.patch = ABM.patches.patch(this.x, this.y);
      if ((oldPatch.agents != null) && oldPatch !== this.patch) {
        u.removeItem(oldPatch.agents, this);
        this.patch.agents.push(this);
      }
      if (this.penDown) {
        drawing = ABM.drawing;
    ...
    Agent.prototype.losePosition = function() {
      u.removeItem(this.patch.agents, this);
