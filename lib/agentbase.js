...
(function() {
  ...
  ABM.Model = (function() {
    ...
    Model.prototype.setWorld = function(options) {
      var classes, defaults, key, value;
      defaults = {
        patchSize: 13,
        mapSize: 32,
        isTorus: false,
      ...
      for (key in classes) {
        if (!__hasProp.call(classes, key)) continue;
        value = classes[key];
        if (options[key] == null) {
          options[key] = value;
        }
  ...
  ABM.Patches = (function(_super) {
    ...
    Patches.prototype.isHeadless = null;
    ...
    Patches.prototype.importColors = function(imageSource, call, map) {
      return u.importImage(imageSource, (function(_this) {
        return function(image) {
          _this.installColors(image, map);
          if (call != null) {
            return call();
          }
        };
    ...
    Patches.prototype.installColors = function(image, map) {
      var data, i, patch, _i, _len;
      u.setIdentity(this.pixelsContext);
      this.pixelsContext.drawImage(image, 0, 0, this.width, this.height);
