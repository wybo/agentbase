...
(function() {
  ...
  ABM.Model = (function() {
    ...
    Model.prototype.setWorld = function(options) {
      var defaults, key, value, worldDefaults, _base1, _base2;
      defaults = {
        isHeadless: false,
        Agents: ABM.Agents,
        Agent: ABM.Agent,
      ...
      if ((_base1 = this.world).min == null) {
        _base1.min = {
          x: -1 * this.world.mapSize / 2,
          y: -1 * this.world.mapSize / 2
        };
      }
      if ((_base2 = this.world).max == null) {
        _base2.max = {
          x: this.world.mapSize / 2,
          y: this.world.mapSize / 2
        };
      }
