...
(function() {
  ...
  ABM.DataSet = DataSet = (function() {
    ...
    DataSet.prototype.toString = function(p, sep) {
      ...
      data = p < 0 ? this.data : u.array.toFixed(this.data, p);
    ...
    DataSet.prototype.toContext = function() {
      var context, d, data, i, idata, j, num, ta, _i, _len;
      context = u.createContext(this.width, this.height);
      idata = context.getImageData(0, 0, this.width, this.height);
      ta = idata.data;
      if (this.normalizeImage) {
        if (this.gray) {
          data = u.array.normalize8(this.data);
        } else {
          data = u.array.normalizeInt(this.data, 0, Math.pow(2, 24) - 1);
        }
      } else {
        data = (function() {
    ...
    DataSet.prototype.normalize = function(lo, hi) {
      return new DataSet(this.width, this.height, u.array.normalize(this.data, lo, hi));
    };

    DataSet.prototype.normalize8 = function() {
      return new DataSet(this.width, this.height, u.array.normalize8(this.data));
    };
    ...
    DataSet.prototype.convolve = function(kernel, factor) {
      var array, h, i, multiplied, n, value, w, x, x0, y, y0, _i, _j, _k, _len;
      if (factor == null) {
        factor = 1;
      }
      array = [];
