...
(function() {
  ...
  ABM.DataSet = DataSet = (function() {
    ...
    DataSet.prototype.patchSample = function(px, py, model) {
      ...
      world = model.world;
      return this.coordSample(px, py, world.minXcor, world.maxYcor, world.numX, world.numY);
    };

    DataSet.prototype.normalize = function(lo, hi) {
      return new DataSet(this.width, this.height, u.array.normalize(this.data, lo, hi), this.model);
    };

    DataSet.prototype.normalize8 = function() {
      return new DataSet(this.width, this.height, u.array.normalize8(this.data), this.model);
    };
