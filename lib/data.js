...
(function() {
  ...
  ABM.DataSet = DataSet = (function() {
    ...
    DataSet.prototype.slopeAndAspect = function(noNaNs, posAngle) {
      var aspect, dzdx, dzdy, gx, gy, n, rad, slope, x, y, _i, _j, _ref, _ref1;
      if (noNaNs == null) {
        noNaNs = true;
      }
      if (posAngle == null) {
  ...
  ABM.ImageDataSet = ImageDataSet = (function(_super) {
    ...
    ImageDataSet.prototype.parse = function(img) {
      var data;
      this.img = img;
      this.rowsPerSlice || (this.rowsPerSlice = this.img.height);
      data = u.imageRowsToData(this.img, this.rowsPerSlice, this.f, this.arrayType);
      return this.reset(this.img.width, this.img.height, data);
    };
